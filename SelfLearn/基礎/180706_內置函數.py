...
# all() 判斷全部元素是否都是True，但空可跌代對象也會傳回True
...
# bytes() 編碼
# print(bytes("你好", encoding='utf-8'))  # => b'\xe4\xbd\xa0\xe5\xa5\xbd'，一個中文字佔三個字節
# print("你好".encode('utf-8'))  # => b'\xe4\xbd\xa0\xe5\xa5\xbd'
# print(type(bytes("你好", encoding='utf-8')))  # => <class 'bytes'>
# print(bytes("你好", encoding='utf-8').decode("utf-8"))  # => 你好，解碼
...
# print(max([1, -2, 10]))  # => 10
# 高階用法
# age_dic = {"age1": 18, "age2": 28, "age3": 40, "age4": 100, "age100": 10}
