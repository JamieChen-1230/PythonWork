...
# import 1.會把導入的模塊先執行一遍 2.引入模塊變量名
# import cal  # 導入自定義cal模塊，並引入cal變量名
# print(cal.add(3, 5))  # => 8
# print(cal.sub(3, 5))  # => -2
...
# 因為目前路徑只到180715_模塊介紹，所以需加入my_module.my_module2才能到my_module2去找cal2
...
#     print(os.path.abspath(__file__))  # => D:/PythonWork/SelfLearn/基礎/180715_模塊基本架構介紹/180715_模塊基本架構介紹.py，文件絕對路徑
#     print(os.path.dirname(os.path.abspath(__file__)))  # => D:/PythonWork/SelfLearn/基礎/180715_模塊基本架構介紹，跳上一級
#     print(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # => D:/PythonWork/SelfLearn/基礎
#
#     BASE_DIR = sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))  # 把上一級目錄加入sys.path
#     # 這樣就能調用 D:/PythonWork/SelfLearn/基礎 目錄上的東西了
#
# # from....
