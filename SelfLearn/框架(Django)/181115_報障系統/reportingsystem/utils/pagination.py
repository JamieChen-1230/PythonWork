...
class Pagination(object):
    ...
    def page_str(self, base_url):
        ...
        page_list = []
        # --------首頁--------
        first = "<li><a href='%s?p=%s'>首頁</a></li>" % (base_url, 1)
        ...
        if self.currentPage == 1:
            ...
            prev = "<li><a href='%s?p=%s'>上一頁</a></li>" % (base_url, self.currentPage - 1)
        ...
        if self.currentPage == self.num_pages:
            ...
            forward = "<li><a href='%s?p=%s'>下一頁</a></li>" % (base_url, self.currentPage + 1)
        page_list.append(forward)

        # --------尾頁--------
        last = "<li><a href='%s?p=%s'>尾頁</a></li>" % (base_url, self.num_pages)
